...
public class Resilience4jController {
  ...
  public Mono<Response<String>> error() {
    String service1URL = "http://localhost:8081/api/response";
  ...
  public Mono<Response<String>> fallback(Exception ex) {
    return Mono.just(toResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Response 500 from Service 2"))
  ...
  private Response<String> toOkResponse() {
    return toResponse(HttpStatus.OK, "Service 3 Response: UP");
  }
